...
def main():
    ...
    if mode == 'encrypt':
        ...
        pubKeyFilename = input('pubkey.filename: ') + ('_pubkey.txt') # braucht öffentlichen schlüssel
        print('Encrypting and writing to %s...' % (filename)) #wird in dieses oben genannte Kopiert
        encryptedText = encryptAndWriteToFile(filename, pubKeyFilename, message)
        print('Encrypted text:')
        print(encryptedText)
    elif mode == 'decrypt':
        privKeyFilename = input('privkey.filename: ') + ('_privkey.txt') #muss privaten Schlüssel verwenden
        print('Reading from %s and decrypting...' % (filename)) #wird vom oben genannten abgelesen
